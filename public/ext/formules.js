// COPIE FIDÈLE de « src/lib/formules.ts ».
//
// L'extension ne peut pas importer un module TypeScript du site : elle est
// livrée seule, dans un dossier que Chrome charge. Le banc
// « outils/formules.cjs » compare les DEUX fichiers sur les mêmes cas — si
// l'un dérive, il le dit. C'est la seule façon honnête de garder une copie.
...
function nettoyerFormules(texte) {
